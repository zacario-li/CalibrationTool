...
class TabHandEye():
    ...
    def create_main_ui(self):
        ...
        self.m_radioBox1 = wx.RadioBox(self.tab, wx.ID_ANY, u"Calib Type", wx.DefaultPosition,
                                       wx.DefaultSize, m_radioBox1Choices, 1, wx.RA_SPECIFY_ROWS)
        self.m_radioBox1.SetSelection(0)
        m_layout_he_type.Add(self.m_radioBox1, 0,
                             wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)

        self.m_checkBox1 = wx.CheckBox(
            self.tab, wx.ID_ANY, u"R Only", wx.DefaultPosition, wx.DefaultSize, 0)
        m_layout_he_type.Add(self.m_checkBox1, 0,
                             wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        ...
        m_radioBox2Choices = [u"TSAI", u"PARK",
                              u"HORAUD", u"ANDREFF", u"DANIILIDIS"]
        self.m_radioBox2 = wx.RadioBox(self.tab, wx.ID_ANY, u"AX=XB Calib Method",
                                       wx.DefaultPosition, wx.DefaultSize, m_radioBox2Choices, 1, wx.RA_SPECIFY_ROWS)
        self.m_radioBox2.SetSelection(2)
        m_layout_he_calib_method.Add(self.m_radioBox2, 0, wx.ALL, 5)

        m_radioBox3Choices = [u"SHAH", u"LI"]
        self.m_radioBox3 = wx.RadioBox(self.tab, wx.ID_ANY, u"AX=YB Calib Method",
                                       wx.DefaultPosition, wx.DefaultSize, m_radioBox3Choices, 1, wx.RA_SPECIFY_ROWS)
        ...
        m_layout_he_dataloader_path_main.Add(
            m_layout_he_dataloader_A, 10, wx.EXPAND, 5)
        ...
        m_layout_he_dataloader_path_main.Add(
            m_layout_he_dataloader_BY, 10, wx.EXPAND, 5)
        ...
        m_layout_he_dataloader_path_main.Add(
            m_layout_he_dataloader_param, 10, wx.EXPAND, 5)

        m_layout__he_dataloader.Add(
            m_layout_he_dataloader_path_main, 10, wx.EXPAND, 5)
        ...
        self.m_bitmap3 = wx.StaticBitmap(
